  ...
  <body>
    <div class="main-wrapper">
      ...
      <div class="content-wrapper">
        ...
        <hr>
			<p><label>Contact:<label><input type=text value="<?php echo $contact_num ?>"/ readonly></p>
			<p><label>Address:<label><input type=text value="<?php echo $address ?>"/ readonly></p>
        <hr>
		 ...
		 <?php
              ...
              $sql = "SELECT  emergency.last_name, emergency.first_name, emergency.middle_name, emergency.contact_num,
			  emergency.address  FROM emergency LEFT JOIN student ON emergency.em_id=student.em_id where student_id='$id';";
              $result = mysqli_query($conn, $sql);
              $resultCheck = mysqli_num_rows($result);
        ...
        <hr>
			<p><label>Name:<label><input type=text value="<?php echo $em_last_name.", ".$em_first_name." ".substr($em_middle_name, 0, 1) ."." ?>"/ readonly></p>
			<p><label>Contact:<label><input type=text value="<?php echo $em_contact_num ?>"/ readonly></p>
			<p><label>Address:<label><input type=text value="<?php echo $em_address ?>"/ readonly></p>
      </div>
